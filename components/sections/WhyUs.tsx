    ...
    <section id="jak-pracujemy" className="bg-paper py-section-xs">
      <Container>
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-4 lg:gap-5 items-start">
          <div className="relative rounded-3xl overflow-hidden aspect-[3/4] lg:aspect-auto lg:min-h-[720px] bg-cream-deep">
            <Image
            ...
            <div className="grid sm:grid-cols-2 gap-4 lg:gap-5">
              {features.map((f, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="rounded-2xl bg-cream-deep p-6 lg:p-8 flex flex-col gap-4"
                  >
